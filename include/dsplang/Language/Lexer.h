...
#ifndef DSPLANG_LEXER_H
#define DSPLANG_LEXER_H
  ...
  Token getTok() {
    ...
    if (isalpha(lastChar)) {
      ...
      if (identifierStr == "var")
        return tok_var;
      if (identifierStr == "si8")
        return tok_type_si8;
      if (identifierStr == "ui8")
        return tok_type_ui8;
      if (identifierStr == "si16")
        return tok_type_si16;
      if (identifierStr == "ui16")
        return tok_type_ui16;
      if (identifierStr == "si32")
        return tok_type_si32;
      if (identifierStr == "ui32")
        return tok_type_ui32;
