...
#include "dsplang/Dialect/Dsplang/IR/ShapeInferenceOpInterfaces.cpp.inc"
...
struct ShapeInferencePass
    : public mlir::PassWrapper<ShapeInferencePass,
                               OperationPass<dsplang::FuncOp>> {
  MLIR_DEFINE_EXPLICIT_INTERNAL_INLINE_TYPE_ID(ShapeInferencePass)
  StringRef getArgument() const override { return "dsplang-shape-inference"; }
...
std::unique_ptr<mlir::Pass> dsplang::createShapeInferencePass() {
